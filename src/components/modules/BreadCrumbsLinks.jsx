...
import removePrefixFromCurrentPath from '../../utils/removePrefixFromCurrentPath'; // uncomment to use with new repo
...
function BreadCrumbsLinks() {
  const location = removePrefixFromCurrentPath(); // uncomment to use with new repo

  return (
    <BreadCrumbsLinksComponent location={location}/> // uncomment to use with new repo
  )
}
